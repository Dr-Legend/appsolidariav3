...
class PdfDemoState extends State<PdfDemo> {
  ...
  Future<void> _saveAsFile() async {
    ...
    await file.writeAsBytes((await generateDocument(PdfPageFormat.a3)).save());
  ...
  Future<void> _sharePdf() async {
    print('Share ...');
    final pdf.Document document = await generateDocument(PdfPageFormat.a3);
    ...
    await Printing.sharePdf(
        bytes: document.save(), filename: 'Chimbi.pdf', bounds: bounds);
  }
